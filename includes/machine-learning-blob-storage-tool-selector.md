> [AZURE.SELECTOR]
- [Επισκόπηση](../articles/machine-learning/machine-learning-data-science-move-azure-blob.md)
- [Azure αποθήκευσης-Εξερεύνηση](../articles/machine-learning/machine-learning-data-science-move-data-to-azure-blob-using-azure-storage-explorer.md)
