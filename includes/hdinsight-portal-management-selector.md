> [AZURE.SELECTOR]
- [Πύλη (Linux σύμπλεγμα)](../articles/hdinsight/hdinsight-administer-use-portal-linux.md)
- [Πύλη (Windows σύμπλεγμα)](../articles/hdinsight/hdinsight-administer-use-management-portal.md)
