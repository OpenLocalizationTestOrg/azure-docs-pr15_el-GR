<properties
   pageTitle="Προβολές συστήματος αποθήκη δεδομένων του SQL | Microsoft Azure"
   description="Συνδέσεις σε σύστημα βλέπει περιεχόμενο για αποθήκη δεδομένων του SQL."
...
# <a name="system-views"></a>Προβολές συστήματος

## <a name="sql-data-warehouse-catalog-views"></a>Προβολές καταλόγου αποθήκη δεδομένων του SQL
...
## <a name="sql-data-warehouse-dynamic-management-views-dmvs"></a>Διαχείριση δυναμικών προβολών αποθήκη δεδομένων του SQL (DMVs)
...
## <a name="sql-server-dmvs-applicable-to-sql-data-warehouse"></a>SQL Server DMVs ισχύουν για αποθήκη δεδομένων του SQL

Το παρακάτω DMVs ισχύουν για αποθήκη δεδομένων του SQL, αλλά πρέπει να εκτελείται κατά τη σύνδεση με την **κύρια** βάση δεδομένων.

- [sys.database_service_objectives](https://msdn.microsoft.com/library/mt712619.aspx)
- [sys.dm_operation_status](https://msdn.microsoft.com/library/dn270022.aspx)
- [sys.fn_helpcollations()](https://msdn.microsoft.com/library/ms187963.aspx)

## <a name="sql-server-catalog-views"></a>Προβολές του καταλόγου SQL Server
...
## <a name="sql-server-dmvs-available-in-sql-data-warehouse"></a>SQL Server DMVs διαθέσιμη σε αποθήκη δεδομένων του SQL

Αποθήκη δεδομένων του SQL εκθέτει πολλές από τις προβολές δυναμική διαχείριση SQL Server (DMVs). Αυτές τις προβολές, όταν το οποίο υποβάλλεται ερώτημα σε αποθήκη δεδομένων του SQL, αναφέρετε την κατάσταση των βάσεων δεδομένων SQL που εκτελείται σε τη διανομή.

Εφόσον αποθήκη δεδομένων του SQL είναι ενσωματωμένη στην τεχνολογία MPP της Microsoft, αποθήκη δεδομένων του SQL και σύστημα πλατφόρμα αναλύσεων παράλληλη αποθήκη δεδομένων (PDW) Χρησιμοποιήστε το ίδιο προβολές συστήματος.

Αυτός είναι ο λόγος κάθε μία από αυτές τις DMV περιλαμβάνει μια συγκεκριμένη στήλη που ονομάζεται pdw_node_id. Αυτό είναι το αναγνωριστικό για τον κόμβο υπολογισμού. Στο PDW του υπολογισμού κόμβος είναι ένα ισχυρότερο έννοια για την αρχιτεκτονική. Στο αποθήκη δεδομένων του SQL, την αρχιτεκτονική μεγαλύτερο βαθμό εξαρτάται από τη διανομή.

>[AZURE.NOTE] Για να χρησιμοποιήσετε αυτές τις προβολή, εισαγάγετε 'pdw_nodes_' στο όνομα του, όπως φαίνεται στον παρακάτω πίνακα.


| Όνομα DMV στο αποθήκη δεδομένων του SQL | Σύνδεση προς το θέμα Transact-SQL του SQL Server στο MSDN |
| :----------------------------- | :-------------------------------------------- |
...
| sys.dm_pdw_nodes_os_dispatchers | Τεκμηρίωση Transact-SQL δεν είναι διαθέσιμη. |
...
| sys.dm_pdw_nodes_os_memory_node_access_stats | Τεκμηρίωση Transact-SQL δεν είναι διαθέσιμη. |
...
| sys.dm_pdw_nodes_os_spinlock_stats | Τεκμηρίωση Transact-SQL δεν είναι διαθέσιμη. |
...
## <a name="sql-server-2016-polybase-dmvs-available-in-sql-data-warehouse"></a>SQL Server 2016 PolyBase DMVs διαθέσιμη σε αποθήκη δεδομένων του SQL
...
## <a name="sql-server-informationschema-views"></a>SQL Server INFORMATION_SCHEMA προβολές

- [CHECK_CONSTRAINTS](http://msdn.microsoft.com/library/ms189772.aspx)
- [ΣΤΉΛΕΣ](http://msdn.microsoft.com/library/ms188348.aspx)
- [ΠΑΡΆΜΕΤΡΟΙ](http://msdn.microsoft.com/library/ms173796.aspx)
- [ΔΙΑΔΙΚΑΣΊΕΣ](https://msdn.microsoft.com/library/ms188757.aspx)
- [SCHEMATA](https://msdn.microsoft.com/library/ms182642.aspx)
- [ΠΊΝΑΚΕΣ](http://msdn.microsoft.com/library/ms186224.aspx)
...
- [ΠΡΟΒΟΛΈΣ](http://msdn.microsoft.com/library/ms181381.aspx)
