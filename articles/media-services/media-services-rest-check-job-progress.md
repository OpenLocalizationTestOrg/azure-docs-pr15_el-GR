<properties 
    pageTitle="Πώς μπορώ να ελέγξω την πρόοδο εργασίας χρησιμοποιώντας REST API | Microsoft Azure" 
    description="Μάθετε πώς μπορείτε να παρακολουθείτε την πρόοδο του έργου." 
...
#<a name="how-to-check-job-progress"></a>Πώς μπορείτε να: Έλεγχος προόδου εργασίας
...
Όταν εκτελείτε εργασίες, συχνά απαιτούν ένας τρόπος για να παρακολουθείτε την πρόοδο του έργου. Μπορείτε να βρείτε την κατάσταση της εργασίας, χρησιμοποιώντας την ιδιότητα κατάσταση του έργου. Για περισσότερες πληροφορίες σχετικά με την ιδιότητα μέλους, ανατρέξτε στο θέμα [Εργασία οντότητα ιδιότητες](https://msdn.microsoft.com/library/azure/5100ddd7-92ff-4c37-84d2-4f84fee250a7#job_entity_properties).
