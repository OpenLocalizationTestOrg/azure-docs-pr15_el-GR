...
|                                        | Υπηρεσία εγγραφής κλειδί                          | Αυτό το κλειδί δημιουργείται από την πύλη του Azure κλασική.    |        |
...
Εκτελέστε τα ακόλουθα βήματα στην Azure κλασική πύλη, στη σελίδα **Διαχείριση StorSimple υπηρεσίας** .
